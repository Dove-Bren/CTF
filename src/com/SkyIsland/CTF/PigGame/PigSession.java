...
public class PigSession implements CTFSession, Listener {
	 ...
	 */
	public PigSession(String name, List<CTFTeam> Teams) {
		this.name = name;
		this.Teams = Teams;
		this.scoreboard = Bukkit.getScoreboardManager().getNewScoreboard();
	...
	public CTFTeam createTeam(String name) {
		...
		CTFTeam team = new PigTeam(this, name, score);
		Teams.add(team);
		score.setScore(1);
		score.setScore(0);
		return team;
	...
	public CTFTeam createTeam(String name, List<TeamPlayer> players) {
		...
		team = new PigTeam(this, name, score);
		this.Teams.add(team);
		score.setScore(1);
		score.setScore(0);

...
public class EditSession implements CTFSession, Listener {
	 ...
	 */
	public EditSession(String name) {
		this.name = name;
	 ...
	 */
	public EditSession(String name, List<CTFTeam> Teams) {
		this.name = name;
		this.Teams = Teams;
		this.scoreboard = Bukkit.getScoreboardManager().getNewScoreboard();
	...
	public CTFTeam createTeam(String name) {
		...
		CTFTeam team = new EditTeam(this, name, score);
		Teams.add(team);
		score.setScore(1);
		score.setScore(0);
		return team;
	...
	public CTFTeam createTeam(String name, List<TeamPlayer> players) {
		...
		team = new EditTeam(this, name, score);
		this.Teams.add(team);
		score.setScore(1);
		score.setScore(0);

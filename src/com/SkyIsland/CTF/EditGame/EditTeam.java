...
public class EditTeam implements CTFTeam {
	 ...
	 * @param TeamName
	 */
	public EditTeam(EditSession session, String TeamName, Score score) {
	 ...
	 */
	public EditTeam(EditSession session, String TeamName, Score teamScore, List<TeamPlayer> Players, int score, Goal TeamGoal, List<Location> spawnLocations, List<Location> flagLocations) {
		this.session = session;
		setTeamName(TeamName);
